...
-- CreateIndex
CREATE INDEX "status_logs_issueId_idx" ON "status_logs"("issueId");

-- CreateIndex
CREATE INDEX "status_logs_adminId_idx" ON "status_logs"("adminId");
...
-- AddForeignKey
ALTER TABLE "status_logs" ADD CONSTRAINT "status_logs_issueId_fkey" FOREIGN KEY ("issueId") REFERENCES "issues"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "status_logs" ADD CONSTRAINT "status_logs_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
